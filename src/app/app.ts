...
export class App {
  ...
  protected readonly cameras = signal<Camera[]>([
    {
      id: 1, name: 'Camera 1', ip: '192.168.1.201', user: 'admin', pass:'admin123'},
    { id: 2, name: 'Camera 2', ip: '192.168.1.202', user: 'admin', pass:'admin123' },
    { id: 3, name: 'Camera 3', ip: '192.168.1.203', user: 'admin', pass:'admin123' },
  ]);
